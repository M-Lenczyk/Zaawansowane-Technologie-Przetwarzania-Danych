--LABORATORIUM 1 - Obiektowo-relacyjne bazy danych
...
--zad4
ALTER TYPE samochod ADD MEMBER FUNCTION evaluationFunction
    RETURN NUMBER CASCADE INCLUDING TABLE DATA;
...
CREATE OR REPLACE TYPE BODY samochod AS
    ...
    MEMBER FUNCTION evaluationFunction RETURN NUMBER IS
    BEGIN
...
BEGIN
    ...
    moje_ksiazki.EXTEND();
    moje_ksiazki(9) := 'Python Tutorial';
    DBMS_OUTPUT.PUT_LINE('Limit: ' || moje_ksiazki.LIMIT());
    DBMS_OUTPUT.PUT_LINE('Liczba elementow: ' || moje_ksiazki.COUNT());
...
INSERT INTO zakupy
VALUES (zakup(1, produkty('POMIDOR', 'BANAN', 'KAWA')));
INSERT INTO zakupy
VALUES (zakup(2, produkty('PIWO', 'ORZESZKI')));
...
INSERT INTO AUTA VALUES (AUTO_OSOBOWE('VIPER', 'GTS', 90000, DATE '2022-01-01', 170000, 5, 'TAK'));
